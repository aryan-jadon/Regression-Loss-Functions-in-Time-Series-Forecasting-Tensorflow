...
class DistributedHyperparamOptManager(HyperparamOptManager):
    ...
    Args:
      ...
      worker_number: Worker index defining which set of hyper parameters to
        test.
    ...
    def load_serialised_hyperparam_df(self):
        """Loads serialized hyperparameter ranges from file.
    ...
    """
        ...
        np.random.seed(131)  # for reproducibility of hyper-param list
