...
import libs.tft_model_msle_loss
...
ModelClass = libs.tft_model_msle_loss.TemporalFusionTransformer
...
loss_experiment_tracker.update({
    "Mean Squared Logarithmic Error p10 Loss": str(p10_loss.mean()),
    "Mean Squared Logarithmic Error p50 Loss": str(p50_loss.mean()),
    "Mean Squared Logarithmic Error p90 Loss": str(p90_loss.mean()),
})
