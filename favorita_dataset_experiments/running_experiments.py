...
subprocess.call("python RMSLE_Experiment.py", shell=True)
subprocess.call("python RMSE_Experiment.py", shell=True)
subprocess.call("python Huber_Experiment.py", shell=True)

subprocess.call("python Quantile_Experiment.py", shell=True)
subprocess.call("python LogCosh_Experiment.py", shell=True)
