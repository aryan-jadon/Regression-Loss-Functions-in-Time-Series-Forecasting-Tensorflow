...
import libs.tft_model_nrmse_loss
...
ModelClass = libs.tft_model_nrmse_loss.TemporalFusionTransformer
...
loss_experiment_tracker.update({
    "Normalized Root Mean Squared Error p10 Loss": str(p10_loss.mean()),
    "Normalized Root Mean Squared Error p50 Loss": str(p50_loss.mean()),
    "Normalized Root Mean Squared Error p90 Loss": str(p90_loss.mean()),
})
