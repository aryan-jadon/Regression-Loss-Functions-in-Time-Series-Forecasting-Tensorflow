...
import libs.tft_model_log_cosh
...
ModelClass = libs.tft_model_log_cosh.TemporalFusionTransformer
...
loss_experiment_tracker.update({
    "LogCosh p10 Loss": str(p10_loss.mean()),
    "LogCosh p50 Loss": str(p50_loss.mean()),
    "LogCosh p90 Loss": str(p90_loss.mean()),
})
